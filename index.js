...
module.exports = {
  ...
  mtjAssetV2: (token) => {
    return request(COMMON_BASE_URL + subDomain + '/mtj/asset', false, 'get', { token })
  },
  mtjSettingV2: () => {
    return request(COMMON_BASE_URL + subDomain + '/mtj/setting', false, 'get')
  },
  mtjLogsV2: (data) => {
    return request(COMMON_BASE_URL + subDomain + '/mtj/logs', false, 'post', data)
  },
  mtjStatisticsV2: () => {
    return request(COMMON_BASE_URL + subDomain + '/site/statistics/mjt', false, 'get')
  },
  mtjTransferV2: (data) => {
    return request(COMMON_BASE_URL + subDomain + '/mtj/transfer', false, 'post', data)
  },
  mtjTransferLogsV2: (data) => {
    return request(COMMON_BASE_URL + subDomain + '/mtj/transfer/logs', false, 'post', data)
  },
  ...
  cmsPage: (key) => {
    return request(COMMON_BASE_URL + subDomain + '/cms/page/info', true, 'get', { key })
  },
  cmsTags: () => {
  ...
  yuyueItemDetail: (id) => {
    return request(COMMON_BASE_URL + subDomain + '/yuyue/info', false, 'get', { id })
  },
  yuyueJoin: (data) => {
